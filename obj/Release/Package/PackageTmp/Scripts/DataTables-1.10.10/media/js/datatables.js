 ...
 *   https://datatables.net/download/#bs/jqc-1.11.3,dt-1.10.10,se-1.1.0
 *
 * Included libraries:
 *   jQuery compat 1.11.3, DataTables 1.10.10, Select 1.1.0
 */
				...
				// Convert html into DOM nodes
					...
					if ( !support.tbody ) {
						...
						elem = tag === "table" && !rtbody.test( elem ) ?
							...
							// String was a bare <thead style="background-color:peru;"> or <tfoot>
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/jqc-1.11.3,dt-1.10.10,se-1.1.0",
